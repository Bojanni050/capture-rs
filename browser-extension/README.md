...
Capture vangt alleen een wachtwoordveld op het moment dat het zichtbaar is.
...
Zet je `[browser] port` in `capture.toml` om, pas dan zowel `BRIDGE_URL` in
